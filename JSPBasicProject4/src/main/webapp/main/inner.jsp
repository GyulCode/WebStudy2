...
<table class='table'>
  <tr>
    <td colspan=2>
      내장객체 : 미리 객체를 생성해서 필요시마다 사용이 가능하게 만들어 준다
       -> 모든 서버에서는 request, response, session.. 지원
       -> NodsJs, JSP, PHP, ASP, Django
    </td>
  </tr>
  <tr>
    <td colspan=2>
  ...
  <tr>
    <td colspan=2>
      ...
      <li>JSP파일에서 서블릿 관련 객체 = config</li>
  ...
  <tr>
    ...
    <td width=75%>서버에서 사용자의 일부 정보를 저장:전역변수처럼 사용</td>
  </tr>
  <tr>
